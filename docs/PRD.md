...
> **버전**: v0.7 · 2026-09-12 · **초안 — Dave 와 함께 수정 중. 코드 작업 금지, 계획만.**
...
| **오른쪽 "이 폴더에서"** (≫ 로 접힘) | ① 세션 목록과 상태 ② **폴더 파일 트리(컴팩트)** — 최근 변경 순, 봇이 만든/고친 파일에 점 ③ 루틴 ④ 하네스 요약(CLAUDE.md·스킬·MCP 개수). 이 패널은 **보조**다 — 접어도 대화만으로 일이 된다. |
