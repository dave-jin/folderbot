...
- [ ] B. 채팅 입력창에서 글씨가 흔들린다 — 🔄 재현 실험 착수 (설계 보고 2026-09-19 · 재현은 승인 불필요)
- [ ] B-완료기준 · 재현 조건이 문서로 남아 있다(재현 실패면 시도한 조건 목록)
...
- [ ] G. 채팅의 PDF 칩을 클릭해도 문서 창에서 열리지 않는다 — ⏸ 승인 대기 (원인 실측은 승인 불필요 · 진행)
- [ ] G-완료기준 · 원인(ⓐ/ⓑ/ⓒ)이 실측으로 문서에 남아 있다
